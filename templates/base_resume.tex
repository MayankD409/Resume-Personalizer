...
%     %\resumeSubHeadingListStart
%         \begin{multicols}{3}
%             \begin{itemize}[itemsep=-5pt, parsep=7pt]
%                 \item\small Software Development for Robotics
%                 \item Robot Modeling
%                 \item Processing of Pictorial Information
%                 \item Control of Robotic System
%                 \item Planning for Autonomous Robots
%                 \item Perception for Autonomous Robots
%             \end{itemize}
%         \end{multicols}
...
\section{Experience}
  ...
  \resumeSubheading
      ...
      \justifying
        ...
        % \resumeItem{Automated the Ion Endoluminal robot testing pipeline with 95\% automation and 20\% reduced test time using MATLAB; applied time series analysis and machine learning for equipment failure prediction. Developed a computer vision solution to correct vision probe video feed orientation, using pattern recognition.}
      \resumeItemListEnd
      ...
      \resumeItemListStart
        ...
        % \resumeItem{Developed a deep learning model using Graph Convolutional Networks and bidirectional-GRU for pedestrian path prediction, improving robot navigation with state of the art ADE/FDE metrics and sub-2ms inference time, validated on a Husky robot.}
      \resumeItemListEnd
    ...
    \resumeSubheading
      ...
      \justifying
        ...
        % \resumeItem{Enhanced delivery robot navigation with submap fusion and developed C++ firmware for IoT weight data transmission (Esp32 Node-MCU). Simulated and implemented multi-agent coordination and trajectory tracking using reinforcement learning for intelligent intersection management.}
      \resumeItemListEnd
    ...
    \resumeSubHeadingListStart
        \resumeProjectHeading
          ...
          \resumeItemListStart
            ...
            % \resumeItem{Developed a hybrid RL-MPC framework for autonomous vehicle lane-changing, integrating SAC/PPO/TD3 for dynamic, risk-aware weight adjustment.}
            % \resumeItem{Designed and trained an RL agent using a curriculum-based protocol, achieving improved performance in varying traffic scenarios in the SUMO simulation environment.}
            % \resumeItem{Achieved 30\% higher success rates, 25\% lower collision rates, and 20\% faster lane-change completion compared to traditional MPC systems.}
          \resumeItemListEnd 
          \vspace{-13pt}
          %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
        \resumeProjectHeading
        ...
        \resumeProjectHeading
          ...
          \resumeItemListStart
            \justifying
            % \resumeItem{Developed a vision-based localization and visual odometry method for drones using a particle filter approach with image encoding measurements.}
            % \resumeItem{Implemented and experimented with three image encoders (CNN-based, VecKM-based, Histogram of Features) to generate inputs for the particle filter's measurement model, achieving fast convergence to the drone's ground-truth location.}
            % \resumeItem{Integrated the system with ROS for real-time localization and tested in a realistic Gazebo PX4 SITL environment, validating performance through both visual results and odometry readings.}
        ...
        \resumeProjectHeading
          ...
          \resumeItemListStart
            \justifying
            % \resumeItem{Developed a Structure from Motion (SfM) system to reconstruct 3D structures from 2D image sequences using feature detection (SIFT), matching, and bundle adjustment techniques.}
            % \resumeItem{Implemented camera pose estimation and 3D point cloud generation, achieving accurate 3D reconstructions validated through synthetic and real-world datasets.}
        ...
        \resumeProjectHeading
          ...
          \resumeItemListStart
            ...
            % \resumeItem{Successfully translated the theoretical RIEKF (Right Invariant Extended Kalman Filter) algorithm for object based SLAM into a functional Python implementation,}
            % \resumeItem{Demonstrated in-depth knowledge of RIEKF principles and its benefits over standard EKF for object features in SLAM through a detailed report on the 2022 paper by Yang Song et al.}
          \resumeItemListEnd
          \vspace{-13pt}
          %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
        \resumeProjectHeading
        ...
        %     % \resumeItem{Developed a simulated humanoid robot that autonomously learns to replicate human walking actions by processing video inputs using OpenPose for accurate pose estimation and joint-angle trajectory extraction.}
        %     % \resumeItem{Implemented a reinforcement learning pipeline integrating Generative Adversarial Imitation Learning (GAIL) and Proximal Policy Optimization (PPO), resulting in stable, human-like gait patterns within PyBullet simulations.}
        %     % \resumeItem{Validated imitation accuracy against human video demonstrations, achieving robust real-time humanoid locomotion and efficient convergence in training.}
        %   \resumeItemListEnd
        %   \vspace{-13pt}
        ...
        %   \resumeItemListStart
        %     % \resumeItem{Developed an automatic panorama stitching solution using traditional techniques (Harris Corner Detection, ANMS, feature matching, RANSAC) and deep learning models (HomographyNet) for homography estimation.}
        %     % \resumeItem{Achieved high-quality panoramic stitching with supervised and unsupervised learning, validated through synthetic data and real-world image sets.}
